 ...
 */
const { User, Difficulty, Area, Category, Ingredient, Recipe, IngredientInRecipe, Author } = require('./models');
...
const recipes = [
    new Recipe({
        ...
        preparationDescription: "put that breast into the heat",
        area: new Area(areas[0]),
        author: new Author(users[0]),
        ingredients: [
